...
Since the logs distributor is created before group key distributors, it uses EdDSA signing. If encryption is desired, the possibility of changing the distributor's sigmgr once group keys are in place can be explored.